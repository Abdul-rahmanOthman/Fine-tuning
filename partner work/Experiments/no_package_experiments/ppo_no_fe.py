...
3-  Editing the choose_action() method a little bit to threshold actions
4-  input_dims = 3* num_of_symptoms + 3
6-  DX # change later
7-  No Feature engineering is used
'''
  ...
  def learn(self):
      ...
      for _ in tqdm(range(self.n_epochs)):
          ...
          for batch in batches:
              ...
              entropy_coefficient = 0.1  # Adjust this value as needed
